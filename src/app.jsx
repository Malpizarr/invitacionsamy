  ...
  return (
    <div style={overlayStyle} onClick={onClose}>
      <div style={contentStyle} onClick={(e) => e.stopPropagation()}>
        ...
        >
          Confirmación Exitosa ¡Te esperamos!
        </h2>
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://backendsamy.yellowocean-d65d7c31.australiaeast.azurecontainerapps.io/user/CrearReservacion",
        {
          method: "POST",
          headers: {
    ...
    >
      <section
        style={{
          ...
          backgroundImage:
            'url("/assets/a9e4732d4bbc228fc2abc2206f84f5cb.png")',
      ...
      <section
        style={{
          backgroundImage:
            'url("/assets/marco-flor-margarita-sobre-fondo-verde-claro_53876-101005.png")',
          scrollSnapAlign: "start",
      ...
      <section
        style={{
          scrollSnapAlign: "start",
          backgroundImage:
            "url(/assets/pngtree-beige-daisy-flower-page-border-image_13368886.jpg)",
          backgroundSize: "cover",
          height: "100vh",
          display: "flex",
          flexDirection: "column", // Cambio clave aquí
      ...
      <section
        style={{
          backgroundImage:
            "url(/assets/floral-daisy-flower-page-border-vector.jpg)",
          scrollSnapAlign: "start",
          height: "100vh",
          display: "flex",
          flexDirection: "column", // Cambio clave aquí
      ...
      >
        ...
        >
          Ya que el evento será al aire libre
        </AnimatedText>
        <AnimatedText
          style={{
            textAlign: "center",
      ...
      >
        ...
        >
          En este día tan especial, tu presencia es fundamental. Y si te animas
          a colaborar, juntos vamos a celebrar.{" "}
        </AnimatedText>
        ...
        >
          Un regalito en efectivo, hará este sueño más efectivo. Pero recuerda
          lo más querido, es tenerte aquí conmigo.
        </AnimatedText>
      </section>
      <section
        style={{
          scrollSnapAlign: "start",
          backgroundImage:
            "url(/assets/linda-flor-de-margarida-de-camomila-em-fundo-de-pessego-neutro-conceito-floral-minimalista-com-espac.png)",
          backgroundSize: "cover",
          height: "100vh",
          flexDirection: "column",
          display: "flex",
